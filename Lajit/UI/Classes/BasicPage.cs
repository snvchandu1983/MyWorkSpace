...
namespace LAjitDev.Classes
{
    public class BasicPage : System.Web.UI.Page
    {
        ...
        private int m_EntryFormWidth;

        public int EntryFormWidth
        {
            get { return m_EntryFormWidth; }
            set { m_EntryFormWidth = value; }
        }

        /// <summary>
        /// Specifies whether the current page is a popup or not.
        /// </summary>
        public bool IsPopUp
        {
        ...
        {
            get { return Convert.ToString(Session["LPCollapsed"]) == "1" ? true : false; }
            set { Session["LPCollapsed"] = value ? "1" : "0"; }
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.Master != null)
            {
                ...
                if (this.Page.MasterPageFile.Contains("PopUp.Master"))//Pop Up
                {
                    ...
                    //string strDepth = this.Page.Request.QueryString["depth"];
                    ...
                    //    }
                    //    this.EntryFormWidth = entryFormWidth;
                    //}
                }
            }
            base.OnLoad(e);
        ...
        {
            #region NLog
            logger.Info("This method has been used to set the UI Headers.");
            #endregion
            ...
            if (pnlEntryForm.Page.MasterPageFile.Contains("PopUp.Master"))//Pop Up
            {
                ...
                InitialiseHelpLinks(htcCPGV1Auto, htcEntryFormAuto);
        ...
        /// <seealso cref="InitialiseHelpLinks() in Classes.PCBasicPage"/>
        private void InitialiseHelpLinks(HtmlTableCell htcCPGV1Auto, HtmlTableCell htcEntryFormAuto)
        {
            if (!IsHelpPage)
            {
                ...
                if (nodeHelp != null)
                {
                    ...
                    string script = "javascript:OpenHelpModalPopup('" + isPopUp + "','" + pageInfo + "');return false;";
        ...
        {
            #region NLog
            logger.Info("Does all the Session Validations like Session-Expire, Session is null both on the client and server sides.");
            #endregion
        ...
        public void BindPage()//Control updPanel
        {
            ...
            {
                if (commonObjUI.ButtonsUserControl != null)
                {
        ...
        public void BindJQueryControls(Page page)
        {
            ...
            {
                sb.Append(JQueryUI.RegisterJQueryDatePicker(page, commonObjUI.m_alCalendarTBoxIDS, "mm/dd/y", string.Empty));
            }
