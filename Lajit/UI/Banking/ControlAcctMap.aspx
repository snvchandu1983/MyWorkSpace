<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ControlAcctMap.aspx.cs" Inherits="LAjitDev.Banking.ControlAcctMap"%>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trSICType" align="left" valign="middle" runat="server">   
                                                                <td class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblSICType" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlSICType" runat="server" MapXML="SICType" Width="476px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqSICType" runat="server" MapXML="SICType" ControlToValidate="ddlSICType" ValidationGroup="LAJITEntryForm"
