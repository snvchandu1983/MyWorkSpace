	...
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			function createData(rowid,obj,tb,maxcols){
				...
				//------Modified by Rajesh------//
				//To Replace the dialog's background with the custom image the properties "class='CaptionTD ui-widget-content'" and  
				//"class='DataTD ui-widget-content'" are replaced with class='CaptionTD' and class='DataTD' respectively.
				tdtmpl = "<td class='CaptionTD'>&nbsp;</td><td class='DataTD' style='white-space:pre'>&nbsp;</td>", tmpl=""; //*2
	...
	viewGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			function createData(rowid,obj,tb,maxcols){
				...
				//To Replace the dialog's background with the custom image the properties "class='CaptionTD ui-widget-content'" and  
				//"class='DataTD ui-widget-content'" are replaced with class='CaptionTD' and class='DataTD' respectively.
				tdtmpl = "<td class='CaptionTD' width='"+p.labelswidth+"'>&nbsp;</td><td class='DataTD ui-helper-reset' style='white-space:pre;'>&nbsp;</td>", tmpl="",
				tdtmpl2 = "<td class='CaptionTD'>&nbsp;</td><td class='DataTD' style='white-space:pre;'>&nbsp;</td>",
				...
				$(obj.p.colModel).each( function(i) {
					...
					//Added by Danny to avoid displaying all the columns in the View mode.
