 ...
 * 
 ...
 Changes Made:
 Function $.fn.fmatter.showlink - To change the behaviour of link buttons.
**/
...
;(function($) {
	...
	$.fn.fmatter.showlink = function(cellval, opts) {
        ...
        if(isString(cellval)) {	//add this one even if its blank string
            var lnkId='lnk'+ opts.rowId+'_'+opts.colModel.index;//Added by Danny to Id the link
			return "<a id='"+lnkId+"' onclick='OnLnkClick(this);' href=\"" + idUrl + "\">" + cellval + "</a>";
        }else {
			return $.fn.fmatter.defaultFormat(cellval,opts);
	    }
    };
