...
(function($) {
  $.mbMenu = {
    ...
    options: {
      ...
      openOnRight:false,
      containment:"window",
      iconPath:"../App_Themes/Lajit/Images/",
      hasImages:false,
      fadeInTime:100,
      fadeOutTime:200,
      menuTop:0,
    ...
    buildMbMenu: function(op,m,type,e){
      ...
      $(this.voices).each(function(i){
        ...
        if (op.options.hasImages && !isText){
          ...
          var imgPath=$(voice).attr("img")?$(voice).attr("img"):"spacer.gif";          
        ...
        if(isSeparator)
          line="<div class='separator' style='width:100%; display:inline-block'><img src='"+op.options.iconPath+"spacer.gif' width='1' height='1'></div>";
        if(isText)
        ...
        if(!isSeparator)
        {
          ...
          if($(this).attr("menu"))
          {          
            $(opener.menuContainer).find("#"+m+"_"+i).find(".voice a").wrap("<div class='next'></div>");
            $(opener.menuContainer).find("#"+m+"_"+i).find(".next").addClass("subMenuOpener");
