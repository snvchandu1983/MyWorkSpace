<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ARBillingType.aspx.cs"
    Inherits="LAjitDev.Receivables.ARBillingType" %>
                                                    ...
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trDescription" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                    <LCtrl:LajitTextBox ID="txtDescription" runat="server" MapXML="Description" Width="340px" ></LCtrl:LajitTextBox>                                                                                     
                                                            ...
                                                            <tr id="trSelectBillingClass" align="left" valign="middle" runat="server">     
                                                                 <td class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblSelectBillingClass" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlSelectBillingClass" runat="server" MapXML="SelectBillingClass" Width="346px" ></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqSelectBillingClass" runat="server" MapXML="SelectBillingClass" ControlToValidate="ddlSelectBillingClass" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                    
                                                                </td>
                                                            </tr>
                                                            <tr id="trEntryJob" align="left" valign="middle" runat="server">   
                                                                <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblEntryJob" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlEntryJob" runat="server" MapXML="EntryJob" Width="346px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqEntryJob" runat="server" MapXML="EntryJob" ControlToValidate="ddlEntryJob" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr>
                                                            <tr id="trEntryAccount" align="left" valign="middle" runat="server">
                                                                 <td class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblEntryAccount" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlEntryAccount" runat="server" MapXML="EntryAccount" Width="346px" ></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqEntryAccount" runat="server" MapXML="EntryAccount" ControlToValidate="ddlEntryAccount" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                    
                                                                </td>
                                                            </tr>   
                                                            <tr id="trProjectRevenue" align="left" valign="middle" runat="server">
                                                               <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblProjectRevenue"  SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitCheckBox ID="chkProjectRevenue" runat="server" MapXML="ProjectRevenue"/>
                                                                </td>
                                                            </tr>
