<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FiscalYearPeriod.aspx.cs"
    Inherits="LAjitDev.Financials.FiscalYearPeriod" %>
                                                 ...
                                                 <tr>
                                                    <td align="left" valign="top" style="height:439px">
                                                        <table width="100%"  border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                              <td colspan="2">
                                                                 ...
                                                                 <table cellpadding="0" cellspacing="0" border="0" width="70%">
                                                                       ...
                                                                       <tr id="trFiscalStartDate" align="left" valign="middle" runat="server">
                                                                            <td class="formtext" style="height: 24px; width: 160px">
                                                                                <asp:Label runat="server" ID="lblFiscalStartDate"  SkinID="Label"></asp:Label>
                                                                            </td>
                                                                            <td valign="middle">
                                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <LCtrl:LajitTextBox ID="txtFiscalStartDate" runat="server" MapXML="FiscalStartDate" Width="68px" ></LCtrl:LajitTextBox>                                                                                     
                                                                                        </td>
                                                                                        <td>
                                                                                            <LCtrl:LAjitRequiredFieldValidator ID="reqFiscalStartDate" MapXML="FiscalStartDate" runat="server" ControlToValidate="txtFiscalStartDate" ValidationGroup="LAJITEntryForm"
                                                                       ...
                                                                       <tr id="trFiscalEndDate" align="left" valign="middle" runat="server">
                                                                            <td class="formtext" style="height: 24px; width: 160px">
                                                                                <asp:Label runat="server" ID="lblFiscalEndDate"  SkinID="Label"></asp:Label>
                                                                            </td>
                                                                            <td valign="middle">
                                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        <td>
                                                                                            <LCtrl:LajitTextBox ID="txtFiscalEndDate" runat="server" MapXML="FiscalEndDate" Width="68px" ></LCtrl:LajitTextBox>                                                                                     
                                                                                        </td>
                                                                                        <td>
                                                                                            <LCtrl:LAjitRequiredFieldValidator ID="reqFiscalEndDate" MapXML="FiscalEndDate" runat="server" ControlToValidate="txtFiscalEndDate" ValidationGroup="LAJITEntryForm"
                                                                                            ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                                        </td>
                                                                                    </tr>
                                                                            </table>
                                                                       ...
                                                                       <tr id="trOpenYear" align="left" valign="middle" runat="server">
                                                                            <td class="formtext" style="height: 24px; width: 160px">
                                                                                <asp:Label runat="server" ID="lblOpenYear" SkinID="Label"></asp:Label>
                                                                            </td>
                                                                            <td valign="middle">
                                                                                <LCtrl:LAjitCheckBox ID="chkOpenYear" runat="server" MapXML="OpenYear" />                                                                                                                                                       
                                                                            </td>
                                                                       </tr> 
                                                                 </table>
                                                                  <!-- FiscalYear Table End -->
                                                              </td>
                                                            </tr>
                                                            <tr style="height:1px;" align="right" valign="middle" >                                                                                                                             
                                                               <td align="right" valign="middle" colspan="2">
                                                            ...
                                                            <tr align="center" >
                                                                <td colspan="2">
                                                                    <LCtrl:ChildGridView ID="CGVUC" runat="server" BranchNodeName="FiscalPeriod" />
                                                                </td>
                                                            </tr>
                                                            <!-- FiscalPeriod End -->
