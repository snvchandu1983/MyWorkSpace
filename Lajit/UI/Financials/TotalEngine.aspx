<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TotalEngine.aspx.cs" Inherits="LAjitDev.Financials.TotalEngine" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" style="height: 439px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                                ...
                                                                <td colspan="3">
                                                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                                        <tr>
                                                                            ...
                                                                            <td valign="middle">
                                                                                <LCtrl:LAjitTextBox ID="txtTitleDef" runat="server" MapXML="TitleDef" Width="200px"></LCtrl:LAjitTextBox>
                                                            ...
                                                            <tr align="center">
                                                                <td colspan="4">
                                                                    <LCtrl:ChildGridView ID="CGVUC" runat="server" BranchNodeName="GroupItem" />
                                                                </td>
                                                            </tr>
