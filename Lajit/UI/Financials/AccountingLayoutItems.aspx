<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AccountingLayoutItems.aspx.cs" 
Inherits="LAjitDev.Financials.AccountingLayoutItems"%>
                                                 ...
                                                 <tr>
                                                    <td align="left" valign="top" style="height:439px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                             ...
                                                             <tr id="trFieldName" valign="middle" align="left" runat="server" visible="false">
                                                                    <td style="width: 160px; height: 24px" class="formtext">
                                                                        <asp:Label ID="lblFieldName" runat="server" SkinID="Label"></asp:Label>
                                                                    </td>
                                                                    <td valign="middle">
                                                                        <LCtrl:LajitTextBox ID="txtFieldName" runat="server" MapXML="FieldName" Width="200px"></LCtrl:LajitTextBox>
                                                                    </td>
                                                             </tr>
                                                             
                                                            <tr id="trTypeOfHeading" align="left" valign="middle" runat="server">   
                                                                <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblTypeOfHeading" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlTypeOfHeading" runat="server" MapXML="TypeOfHeading" Width="206px" SkinID="ddlDisabled"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqTypeOfHeading" runat="server" MapXML="TypeOfHeading" ControlToValidate="ddlTypeOfHeading" ValidationGroup="LAJITEntryForm"
                                                            ...
                                                            <tr id="trOrderSeq" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblOrderSeq" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LajitTextBox ID="txtOrderSeq" runat="server" MapXML="OrderSeq" Width="200px"  SkinID="txtDisabled" ></LCtrl:LajitTextBox>                                                                                     
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqOrderSeq" MapXML="OrderSeq" runat="server" ControlToValidate="txtOrderSeq" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>  
                                                                    <LCtrl:LAjitRegularExpressionValidator ID="regOrderSeq" runat="server" ControlToValidate="txtOrderSeq" MapXML="OrderSeq"
                                                            ...
                                                            <tr id="trColumnIsActive" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblColumnIsActive" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitCheckBox ID="chkColumnIsActive" runat="server" MapXML="ColumnIsActive"/>
                                                                </td>
                                                            </tr>
