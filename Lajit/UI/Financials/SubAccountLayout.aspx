<%@ Page Language="C#" AutoEventWireup="true" Codebehind="SubAccountLayout.aspx.cs"
    Inherits="LAjitDev.Financials.SubAccountLayout" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" style="height:439px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trSubAcct" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblSubAcct" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitTextBox ID="txtSubAcct" runat="server" MapXML="SubAcct" Width="200px"></LCtrl:LAjitTextBox>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqSubAcct" MapXML="SubAcct" runat="server" ControlToValidate="txtSubAcct" ValidationGroup="LAJITEntryForm"
                                                            ...
                                                            <tr id="trObjectTrxID" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblObjectTrxID" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitLabel ID="lblObjectTrxID_Value" MapXML="ObjectTrxID" runat="server"></LCtrl:LAjitLabel>
                                                                </td>
                                                            </tr>
