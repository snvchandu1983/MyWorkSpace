<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ControlCenter.aspx.cs"
    Inherits="LAjitDev.Financials.ControlCenter" %>
                                ...
                                <tr align="left">
                                     <td class="tdEntryFrm">
                                        <asp:Panel ID="pnlEntryForm" runat="server" Height="511px">
                                            <!-- entry form start -->
                                              <table style="height: 100%" width="100%"  border="0" cellspacing="0" cellpadding="0" class="formmiddle">
                                               <!--Pop up header tr-->
                                                    ...
                                                    <td align="left" valign="top" style="height:439px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trDescription" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitTextBox ID="txtDescription" runat="server" MapXML="Description" Width="146px"></LCtrl:LAjitTextBox>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqDescription" runat="server" ControlToValidate="txtDescription" ValidationGroup="LAJITEntryForm" Enabled="false"
                                                                      ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" MapXML="Description"></LCtrl:LAjitRequiredFieldValidator>                                                               
                                                                </td>
                                                            </tr>
                                                            <tr id="trCenterType" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCenterType" runat="server" MapXML="CenterType" Width="146px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCenterType" runat="server" ControlToValidate="ddlCenterType" ValidationGroup="LAJITEntryForm" Enabled="false"
                                                                      ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" MapXML="CenterType"></LCtrl:LAjitRequiredFieldValidator>                                                                  
                                                                </td>
                                                            </tr>
                                                            <tr id="trCurrencyTypeCompany" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCurrencyTypeCompany" runat="server" MapXML="CurrencyTypeCompany" Width="146px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCurrencyTypeCompany" runat="server" ControlToValidate="ddlCurrencyTypeCompany" ValidationGroup="LAJITEntryForm" Enabled="false"
                                                                      ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" MapXML="CurrencyTypeCompany"></LCtrl:LAjitRequiredFieldValidator>                                                    
                                                                </td>
                                                            </tr>
                                                            <tr id="trRollupAccount" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlRollupAccount" runat="server" MapXML="RollupAccount" Width="146px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqRollupAccount" runat="server" ControlToValidate="ddlRollupAccount" ValidationGroup="LAJITEntryForm" Enabled="false"
                                                                      ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" MapXML="RollupAccount"></LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr id="trRollupJob" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlRollupJob" runat="server" MapXML="RollupJob" Width="146px"></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqRollupJob" runat="server" ControlToValidate="ddlRollupJob" ValidationGroup="LAJITEntryForm" Enabled="false"
                                                                      ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" MapXML="RollupJob"></LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr id="trControlJobGroup" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblControlJobGroup" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlControlJobGroup" runat="server" MapXML="ControlJobGroup" Width="146px"></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqControlJobGroup" runat="server" ControlToValidate="ddlControlJobGroup" ValidationGroup="LAJITEntryForm" Enabled="false"
                                                                      ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" MapXML="ControlJobGroup"></LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
