<%@ Page Language="C#" AutoEventWireup="true" Codebehind="COA.aspx.cs" Inherits="LAjitDev.Financials.COA"%>
                                                    ...
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trCOAType" align="left" valign="middle" runat="server">   
                                                                <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblCOAType" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCOAType" runat="server" MapXML="COAType" Width="206px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCOAType" runat="server" MapXML="COAType" ControlToValidate="ddlCOAType" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr>
                                                            <tr id="trGroupTotalAcctStd" align="left" valign="middle" runat="server">  
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblGroupTotalAcctStd" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlGroupTotalAcctStd" runat="server" MapXML="GroupTotalAcctStd" Width="206px" ></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqGroupTotalAcctStd" runat="server" MapXML="GroupTotalAcctStd" ControlToValidate="ddlGroupTotalAcctStd" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                    
                                                                </td>
                                                            </tr>                                                                                                                                        
                                                            <tr  id="trGroupTotalCashFlow" align="left" valign="middle" runat="server">  
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblGroupTotalCashFlow" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlGroupTotalCashFlow" runat="server" MapXML="GroupTotalCashFlow" Width="206px" SkinID="ddlDisabled"></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqGroupTotalCashFlow" runat="server" MapXML="GroupTotalCashFlow" ControlToValidate="ddlGroupTotalCashFlow" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                    
                                                                </td>
                                                            </tr>
                                                            <tr  id="trAccountMask" align="left" valign="middle" runat="server">  
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblAccountMask" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlAccountMask" runat="server" MapXML="AccountMask" Width="206px"></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqAccountMask" runat="server" MapXML="AccountMask" ControlToValidate="ddlAccountMask" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                    
                                                                </td>
                                                            </tr>
                                                            <tr id="trAccountHeading" align="left" valign="middle" runat="server">   
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblAccountHeading" SkinID="Label" ></asp:Label>
                                                                 </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlAccountHeading" runat="server" MapXML="AccountHeading" Width="206px"  ></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqAccountHeading" runat="server" MapXML="AccountHeading" ControlToValidate="ddlAccountHeading" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr>
                                                            <tr id="trNumberReq" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label  runat="server" ID="lblNumberReq" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitCheckBox ID="chkNumberReq" runat="server" MapXML="NumberReq" />
                                                               </td>
                                                            </tr>
                                                            <tr id="COAControl" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblCOAControl" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitCheckBox ID="chkCOAControl" runat="server" MapXML="COAControl" />
                                                                </td>
                                                            </tr> 
