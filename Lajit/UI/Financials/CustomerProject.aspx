<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CustomerProject.aspx.cs"
    Inherits="LAjitDev.Financials.CustomerProject" %>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trCustomer" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblCustomer"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCustomer" runat="server" MapXML="Customer"
                                                                        Width="206px">
                                                                    </LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCustomer" runat="server" MapXML="Customer"
                                                                        ControlToValidate="ddlCustomer" ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required."
