<%@ Page Language="C#" AutoEventWireup="true" Codebehind="DirectorProfit.aspx.cs"
    Inherits="LAjitDev.Financials.DirectorProfit" %>
    ...
    function HideShowDiv(divname)
    {
        switch (divname)
        {
            ...
            case "ProfitRules":
                ...
                document.getElementById("divProfitRules").style.display="block"; 
                //Tabs
                document.getElementById("divGeneralInfoTab").style.display="none";
                document.getElementById("divProfitRulesTab").style.display="block"; 
                break;              
        }
    }
    </script>
                    ...
                    <tr>
                        ...
                        <td class="tdMainCont">
                            <table class="tblMainCont" cellpadding="0" cellspacing="0" >
                                ...
                                <tr align="left">
                                     <td class="tdEntryFrm">
                                        <asp:Panel ID="pnlEntryForm" runat="server" Height="555px" Style="background-color: White;"
                                            Width="100%">
                                            <!-- entry form start -->
                                            <table border="0" cellpadding="0" cellspacing="0" style="height: 511px" width="100%">
                                                <!--Pop up header tr-->
                                                ...
                                                <tr align="right" style="height: 1px;" valign="middle">
                                                ...
                                                <tr style="height: 25px;">
                                                    <td valign="bottom">
                                                                ...
                                                                <tr align="left" valign="bottom">
                                                                    ...
                                                                    <td align="center" style="width: 1px;" valign="middle">
                                                                        <img height="21" src="<%=Application["ImagesCDNPath"]%>Images/top-left01.gif"
                                                                            width="5"></td>
                                                                    <td align="center" class="blueboldlinks01" onclick="javascript:HideShowDiv('ProfitRules');"
                                                                        style="width: 150px; background: url(<%=Application["ImagesCDNPath"]%>Images/top-midbg01.gif) repeat-x;"
                                                                        valign="middle">
                                                        ...
                                                        <div id="divProfitRulesTab" style="display: none">
                                                            <table align="left" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0"
                                                                width="45%">
                                                                <tr align="left" valign="bottom">
                                                                    <td align="center" style="width: 5px;" valign="middle">
                                                                    ...
                                                                    <td style="width: 5px;">
                                                                        <img height="21" src="<%=Application["ImagesCDNPath"]%>Images/title-left-curve.gif"
                                                                            width="5"></td>
                                                                    <td align="center" class="bluebold" style="width: 150px; background-color: #c5d5fc;"
                                                                        valign="middle">
                                                                        Profit Participation Rules
                                                                    </td>
                                                                    <td align="center" style="width: 5px;" valign="middle">
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" colspan="2">
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" class="formmiddle" style="height: 500px"
                                                            width="100%">
                                                            <tr style="border-style: none;">
                                                                <td colspan="5" valign="top">
                                                                                    ...
                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                        ...
                                                                                                        <td colspan="2">
                                                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                                                <tr id="trTypeOfJob" valign="middle" runat="server">
                                                                                                                    ...
                                                                                                                    <td valign="middle">
                                                                                                                        <LCtrl:LAjitDropDownList ID="ddlTypeOfJob" runat="server" MapXML="TypeOfJob" Width="306px">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="4" style="height: 24px;">
                                                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                                    <tr id="trDirName" runat="server" valign="middle">
                                                                                                        <td class="formtext" style="height: 24px; width: 160px">
                                                                                                        ...
                                                                                                        <td style="width: 130px" valign="middle">
                                                                                                            <asp:Label ID="lblProfitThreshold" runat="server" SkinID="Label" Width="100%"></asp:Label></td>
                                                                                                        <td style="width: 120px" valign="bottom">
                                                                                                            <LCtrl:LAjitTextBox ID="txtProfitThreshold" runat="server" MapXML="ProfitThreshold"
                                                                                                                Width="100px" Style="vertical-align: middle"></LCtrl:LAjitTextBox>
                                                                                            ...
                                                                                            <td colspan="4" style="height: 24px;">
                                                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                                    <tr id="trProfitCalc" runat="server" valign="middle">
                                                                                                        ...
                                                                                                        <td valign="middle">
                                                                                                            <LCtrl:LAjitDropDownList ID="ddlProfitCalc" runat="server" MapXML="ProfitCalc" Width="306px">
                                                                                                            </LCtrl:LAjitDropDownList>
                                                                                                ...
                                                                                                <table width="100%" border="0" bordercolor="green" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td colspan="2" align="left" style="width:40%">
                                                                                                            <table width="95%" border="0" bordercolor="green" cellspacing="0" cellpadding="0">
                                                                                                        ...
                                                                                                        <td align="left" colspan="2" style="width:60%" valign="middle">
                                                                                                            <table width="90%" border="0" bordercolor="green" cellspacing="0" cellpadding="0" align="left">
                                                                                                                <tr align="left" valign="top" id="trEffectiveDate" runat="server">
                                                                                                                    <td align="left" valign="top" class="formtext" style="height: 24px; width: 170px">
                                                                                            ...
                                                                                            <td colspan="4" style="width: 100%">
                                                                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td align="left" colspan="4" style="width: 65px" valign="top">
                                                                                                            <asp:Label ID="lblSalesRulesHeading" runat="server" SkinID="LabelSubHead" Text="Profit Steps"></asp:Label></td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td valign="top" colspan="4">
                                                                                                <table border="0" cellpadding="0" cellspacing="0">
                                                                                                    <tr>
                                                                                                        <td align="left" colspan="4" style="width: 300px" valign="top">
                                                                                                            <!--Left Table Start -->
                                                                                                            <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr>
                                                                                                                    <td colspan="2">
                                                                                                        ...
                                                                                                        <td align="right" colspan="4" valign="top">
                                                                                                            ...
                                                                                                            <table align="left" border="0" cellpadding="0" cellspacing="0">
                                                                                                                <tr valign="top">
                                                                                                                    <td colspan="4" style="width: 305px;" valign="middle">
                                                                    ...
                                                                    <!-- Panel Director Profit Start  style="height:368px" -->
                                                                    <div id="divProfitRules" style="display: none">
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top">
                                                                                    ...
                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="width: 55%">
                                                                                        <tr valign="top">
                                                                                            <td colspan="2" style="width: 100%;" valign="middle">
                                                                                                <table align="center" border="0" cellpadding="0" cellspacing="0" class="formblackborder"
                                                                                                            ...
                                                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="height: 100%;
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td align="center" colspan="2" valign="middle">
                                                                                                                        <asp:Label ID="lblOtherVariablesHeading" runat="server" SkinID="LabelBig" Text="Profit Variables"></asp:Label>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                                                                            ...
                                                                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="height: 100%;
                                                                                                                ...
                                                                                                                <tr align="left" valign="top">
                                                                                                                    <td style="height: 24px; width: 35%">
                                                                                                                        &nbsp;</td>
                                                                                                                    <td align="center" style="height: 24px; width: 30%" valign="top">
                                                                                                                        <asp:Label ID="lblUse" runat="server" SkinID="Label" Text="Use" Width="100%"></asp:Label></td>
                                                                                                                    <td align="center" style="height: 24px; width: 35%" valign="top">
                                                                                                                ...
                                                                                                                <tr id="trFlatAtoK" runat="server" valign="top">
                                                                                                                    ...
                                                                                                                    <td align="center" style="height: 24px; width: 35%" valign="middle">
                                                                                                                ...
                                                                                                                <!--Row8-->
                                                                                                                <tr id="trSelectProfitAmt8" runat="server" valign="top">
                                                                                                                    <td align="center" style="height: 24px; width: 35%" valign="top">
                                                                                                                        <asp:Label ID="lblSelectProfitAmt8" runat="server" SkinID="Label" Width="100%"></asp:Label>
                                                                                                                    </td>
                                                                                                                    <td align="center" style="height: 24px; width: 30%" valign="top">
