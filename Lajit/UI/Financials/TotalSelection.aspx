<%@ Page Language="C#" AutoEventWireup="true" Codebehind="TotalSelection.aspx.cs" Inherits="LAjitDev.Financials.TotalSelection"%>
                                        ...
                                        <asp:Panel ID="pnlEntryForm" runat="server" Height="511px">
                                            ...
                                            <table style="height: 511px" width="100%" border="0" cellspacing="0" cellpadding="0"
                                                ...
                                                <tr id="trProcessLinks" align="right" valign="middle" runat="server">
                                                    ...
                                                    <td align="left" id="tdSOXLinks" runat="server" style="word-wrap: normal">
                                                        <LCtrl:LAjitLinkButton ID="lnkBtnIsApproved" runat="server" Visible="false" MapXML="IsApproved"
                                                            OnClick="lnkBtnIsApproved_Click"></LCtrl:LAjitLinkButton>
                                                    </td>
                                                </tr>
                                                <!--Page subject tr-->
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <table width="100%"  border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr id="trStartRange" align="left" valign="middle" runat="server">
                                                                <td align="right" valign="top" class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblStartRange" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitTextBox ID="txtStartRange" runat="server" MapXML="StartRange" Width="200px"></LCtrl:LAjitTextBox>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqStartRange" MapXML="StartRange" runat="server"
                                                                        ControlToValidate="txtStartRange" ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required."
                                                                        ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr id="trEndRange" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label runat="server" ID="lblEndRange" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitTextBox ID="txtEndRange" runat="server" MapXML="EndRange" Width="200px"></LCtrl:LAjitTextBox>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqEndRange" MapXML="EndRange" runat="server"
                                                                        ControlToValidate="txtEndRange" ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required."
                                                                        ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
