<%@ Page Language="C#" AutoEventWireup="true" Codebehind="AccountControl.aspx.cs" Inherits="LAjitDev.Financials.AccountControl" %>
                                                    ...
                                                    <td align="left" valign="top" style="height:439px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trDescription" align="left" valign="middle" runat="server">
                                                             ...
                                                             <tr id="trValue" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label  SkinID="Label" runat="server" ID="lblValue"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LajitTextBox ID="txtValue" runat="server" MapXML="Value" Width="200px" ></LCtrl:LajitTextBox>                                                                                     
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqValue" MapXML="Value" runat="server" ControlToValidate="txtValue" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                                                                                       
                                                                </td>
                                                            </tr>
