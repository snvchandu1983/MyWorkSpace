<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Code1099T4.aspx.cs" Inherits="LAjitDev.Payables.Code1099T4" %>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <!-- MODIFY/DELETE/VIEW only display -->
                                                             <tr id="trSoxApprovedStatus" valign="middle" align="left" runat="server">
                                                               ...
                                                               <tr id="trTypeOf1099T4" valign="middle" align="left" runat="server">   
                                                                <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblTypeOf1099T4" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlTypeOf1099T4" runat="server" MapXML="TypeOf1099T4" Width="206px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqTypeOf1099T4" runat="server" MapXML="TypeOf1099T4" ControlToValidate="ddlTypeOf1099T4" ValidationGroup="LAJITEntryForm"
                                                              ...
                                                              <tr id="trIsApproved" valign="middle" align="left" runat="server" visible="false">
                                                                    <td style="width: 160px; height: 24px" class="formtext">
                                                                        <asp:Label ID="lblIsApproved" runat="server" SkinID="Label"></asp:Label>
                                                                    </td>
                                                                    <td valign="middle">
                                                                        <LCtrl:LAjitCheckBox ID="chkIsApproved" runat="server" MapXML="IsApproved"></LCtrl:LAjitCheckBox>
                                                                    </td>
                                                                </tr> 
                                                           <tr>
                                                             <td colspan="2">&nbsp;</td>
                                                           ...
                                                           <tr style="height:24px">
                                                               <td style="width: 160px; height: 24px" class="formtext">&nbsp;</td>
                                                               <td align="left">
                                                                <table border="0" >
                                                                   <tr>
                                                                        <td>
