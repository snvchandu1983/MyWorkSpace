<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ManualCheck.aspx.cs" Inherits="LAjitDev.Payables.ManualCheck" %>
                                ...
                                <tr align="left">
                                     <td class="tdEntryFrm">
                                        <asp:Panel ID="pnlEntryForm" runat="server" Height="611px">
                                            <!-- entry form start -->
                                            <table style="height: 511px" align="center" width="100%" border="0" bordercolor="red" cellspacing="0" cellpadding="0" >
                                                <!--Pop up header tr-->
                                                ...
                                                <td valign="top">
                                                 <!-- Quick Check Start  -->
                                                  <table cellpadding="0" width="100%" border="0" cellspacing="0" class="formcheckborder">
                                                                 ...
                                                                 <td align="left">
                                                                    <table cellpadding="0" cellspacing="0"  border="0">
                                                                      <tr align="left" valign="middle" id="trEntryBank_JournalDoc" runat="server">
                                                                          <td align="left" class="formtext" style="height:24px; width:111px;">
                                                                 ...
                                                                 <td align="right">
                                                                     <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr align="left" valign="top" id="trCheckNumber_JournalDoc" runat="server">
                                                                            <td class="formtext" style="height:24px; width:91px;">
                                                                             ...
                                                                             <td valign="middle" style="width:136px; ">
                                                                                <LCtrl:LAjitTextBox ID="txtCheckNumber_JournalDoc" runat="server" MapXML="CheckNumber" MapBranchNode="JournalDoc" Width="125px"></LCtrl:LAjitTextBox>                                                                                <LCtrl:LAjitRequiredFieldValidator ID="reqCheckNumber_JournalDoc" MapXML="CheckNumber" MapBranchNode="JournalDoc" runat="server" ControlToValidate="txtCheckNumber_JournalDoc" 
                                                                 ...
                                                                 <td align="left">
                                                                  ...
                                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                                   <tr align="left" valign="middle" id="trAutoFillVendor_JournalDoc" runat="server">
                                                                        <td class="formtext" style="height:24px;width:111px;"  valign="top">
                                                                            <asp:Label runat="server" ID="lblAutoFillVendor_JournalDoc" MapBranchNode="JournalDoc" SkinID="LabelBig"></asp:Label>
                                                                        </td>
                                                                         <td valign="middle" style="width:380px; ">
                                                                                <LCtrl:LAjitTextBox ID="txtAutoFillVendor_JournalDoc" runat="server" MapXML="AutoFillVendor" MapBranchNode="JournalDoc" Width="370px"></LCtrl:LAjitTextBox>
                                                                                <LCtrl:LAjitRequiredFieldValidator ID="reqAutoFillVendor_JournalDoc" runat="server" ControlToValidate="txtAutoFillVendor_JournalDoc"  MapBranchNode="JournalDoc" MapXML="AutoFillVendor"
                                                                                 ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>  
                                                                         </td>         
                                                                      </tr> 
                                                                    </table>
                                                               ...
                                                               <!-- payment date -->
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                  <tr id="trPaymentDate_JournalDoc" align="left" valign="middle" runat="server">
                                                                     <td class="formtext" style="height: 24px; width:91px" valign="top">
                                                                         <asp:Label runat="server" ID="lblPaymentDate_JournalDoc"  SkinID="LabelBig"></asp:Label>
                                                                     </td>
                                                                     <td valign="middle" style="width:136px; ">
                                                                       <LCtrl:LajitTextBox ID="txtPaymentDate_JournalDoc" runat="server" MapXML="PaymentDate" Width="110px" ></LCtrl:LajitTextBox>                                                                                     
                                                               ...
                                                               <td align="left">
                                                                  ...
                                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                                      <tr align="left" valign="top" id="trSelectAPInvoiceType_JournalDoc" runat="server">
                                                                        <td class="formtext" style="height:24px; width:111px;">
                                                                   ...
                                                                   <table cellpadding="0" cellspacing="0" border="0">
                                                                         <tr id="trControlTotal" align="left" valign="middle" runat="server">
                                                                            <td class="formtext" style="height: 24px; width:91px;" valign="top">
                                                                             ...
                                                                             <td valign="middle" style="width:136px; ">
                                                                                <LCtrl:LajitTextBox ID="txtControlTotal" runat="server" MapXML="ControlTotal" Width="125px" ></LCtrl:LajitTextBox>                                                                                     
                                                                  ...
                                                                  <tr>
                                                                    <td valign="top">
                                                                       <!-- left table 2 start -->
                                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                                        <tr>
                                                                           <td colspan="2" align="left" style="height: 24px; width:491px">
                                                                                 <!-- table Description start width="550px" width="342px"-->
                                                                                 <table cellpadding="0" cellspacing="0" border="0">
                                                                                      <tr id="trDescription" align="left" valign="middle" runat="server">
                                                                                        ...
                                                                                        <td valign="middle">
                                                                                            <LCtrl:LajitTextBox ID="txtDescription" runat="server" MapXML="Description"  Width="343px" ></LCtrl:LajitTextBox>                                                                                     
                                                                              ...
                                                                              <table cellpadding="0" cellspacing="0" border="0">
                                                                                <tr id="trInvDate" align="left" valign="middle" runat="server">
                                                                                    <td class="formtext" style="height: 24px; width:100px" valign="top">
                                                                                     ...
                                                                                     <td valign="middle" align="Right" style="width:102px;">
                                                                                         <table border="0" cellpadding="0" cellspacing="0">
                                                                                             <tr>
                                                                                                <td>
                                                                                                    <LCtrl:LajitTextBox ID="txtInvDate" runat="server" MapXML="InvDate" Width="73px" ></LCtrl:LajitTextBox>                                                                                     
                                                                        ...
                                                                        <tr>
                                                                           <td colspan="2">
                                                                             <!-- table POReference start -->
                                                                                 <table cellpadding="0" cellspacing="0" border="0">
                                                                                    <tr id="trPOReference_JournalDoc" align="left" valign="middle" runat="server">
                                                                                        <td  class="formtext" style="height: 24px; width:111px" valign="top">
                                                                                           <asp:Label runat="server" ID="lblPOReference_JournalDoc" SkinID="LabelBig"></asp:Label>
                                                                                        </td>
                                                                                         <td valign="middle" >
                                                                                           <LCtrl:LajitTextBox ID="txtPOReference_JournalDoc" runat="server" MapXML="POReference" MapBranchNode="JournalDoc" Width="343px"></LCtrl:LajitTextBox>
                                                                                           <LCtrl:LAjitRequiredFieldValidator ID="reqPOReference_JournalDoc" runat="server" MapXML="POReference" MapBranchNode="JournalDoc" ControlToValidate="txtPOReference_JournalDoc" ValidationGroup="LAJITEntryForm"
                                                                                                ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                                        </td>
                                                                                    </tr>
                                                                                 </table>
                                                                               <!-- table POReference end -->
                                                                           </td>
                                                                        </tr>
                                                                 ...
                                                                 <!-- Currency Start -->
                                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                                         ...
                                                                         <table cellpadding="0" cellspacing="0" border="0">
                                                                               <tr id="trCurrencyTypeCompany" align="left" valign="middle" runat="server">
                                                                                    <td  class="formtext" style="height: 24px; width:91px;" valign="top">
                                                                                     ...
                                                                                     <td valign="middle" style="width:136px; ">
                                                                                        <LCtrl:LAjitDropDownList ID="ddlCurrencyTypeCompany" runat="server" MapXML="CurrencyTypeCompany" Width="130px"></LCtrl:LAjitDropDownList>
                                                                   ...
                                                                   <tr>
                                                                     <td valign="top">
                                                                       <!--Postledger -->
                                                                         <table cellpadding="0" cellspacing="0" border="0"  style="margin-left:5px; margin-right:10px; margin-top:10px; margin-bottom:10px;">
                                                                            <tr>
                                                                               <td valign="middle" >
                                                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                                                          <tr id="trPostToLedger" align="left" valign="middle" runat="server">
                                                                                                <td class="formtext" style="height: 24px; width: 91px" valign="top" align="left">
                                                                                                    <asp:Label runat="server" ID="lblPostToLedger" SkinID="Label" Width="80px" ></asp:Label>
                                                                                                </td>
                                                                                                <td valign="middle" style="width: 10px;" colspan="2">
                                                      ...
                                                      <tr>
                                                           <td>                                           
                                                            <!-- Payment Methods and Postledger Start -->
                                                             <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                             <tr>
                                                               <td align="left">
                                                                  <!-- Check Message Start -->
                                                                   <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr align="center" valign="middle" id="trCheckMessage_JournalDoc" runat="server">
                                                                      <td style="width:236px;height:24px;" align="center">
