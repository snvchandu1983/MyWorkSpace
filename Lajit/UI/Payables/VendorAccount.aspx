<%@ Page Language="C#" AutoEventWireup="true" Codebehind="VendorAccount.aspx.cs" Inherits="LAjitDev.Payables.VendorAccount"%>
...
<asp:content id="Content1" contentplaceholderid="cphPageContents" runat="server">
    <asp:Panel ID="pnlContent" runat="server">
        <asp:UpdatePanel runat="server" ID="updtPnlContent">
            <contenttemplate>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" >
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">   
                                                            ...
                                                            <tr id="trEntryAccount">  
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label runat="server" ID="lblEntryAccount" SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlEntryAccount" runat="server" MapXML="EntryAccount" Width="206px" ></LCtrl:LAjitDropDownList>
                ...
                <asp:hiddenField ID="hdnEntryAccount" runat="server" />
    ...
    <script type="text/javascript" >
        ...
        {
            document.getElementById('ctl00_cphPageContents_ddlEntryAccount').disabled=true;  
            HideParentProgress();
        }   
    </script>
