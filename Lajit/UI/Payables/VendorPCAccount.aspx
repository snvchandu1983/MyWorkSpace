<%@ Page Language="C#" AutoEventWireup="true" Codebehind="VendorPCAccount.aspx.cs" Inherits="LAjitDev.Payables.VendorPCAccount"%>
...
<asp:content id="Content1" contentplaceholderid="cphPageContents" runat="server">
    <asp:Panel ID="pnlContent" runat="server">
        <asp:UpdatePanel runat="server" ID="updtPnlContent">
            <contenttemplate>
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                           <tr style="height:1px;" align="right" valign="middle" >                                                                                                                             
                                                            ...
                                                            <tr id="trFloatAmount" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                    <LCtrl:LajitTextBox ID="txtFloatAmount" runat="server" MapXML="FloatAmount" Width="200px" ></LCtrl:LajitTextBox>                                                                                     
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqFloatAmount" MapXML="FloatAmount" runat="server" ControlToValidate="txtFloatAmount" ValidationGroup="LAJITEntryForm"
                                                            ...
                                                            <tr id="trEntryJob" align="left" valign="middle" runat="server">
                                                                ...
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlEntryJob" runat="server" MapXML="EntryJob" Width="206px"></LCtrl:LAjitDropDownList>
                                                            ...
                                                            <tr id="trEntryPCAccount" align="left" valign="middle" runat="server">
                                                                <td  class="formtext" style="height: 24px; width:160px" valign="top">
                                                                    <asp:Label   runat="server" ID="lblEntryPCAccount" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlEntryPCAccount" runat="server" MapXML="EntryPCAccount" Width="206px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqEntryPCAccount" runat="server" MapXML="EntryPCAccount" ControlToValidate="ddlEntryPCAccount" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr>
                ...
                <asp:hiddenField ID="hdnEntryJob" runat="server" />
                <asp:hiddenField ID="hdnEntryPCAccount" runat="server" />
                <asp:hiddenField ID="hdnCOA" runat="server" />
   ...
   <script type="text/javascript" >
    ...
    {
        document.getElementById('ctl00_cphPageContents_ddlEntryPCAccount').disabled=true;  
        //hide loading image  
        HideParentProgress(); 
    }  
   </script> 
    <%--<script type="text/javascript" src="../JavaScript/CascadingDropDowns.js"></script>--%>
</asp:content>
