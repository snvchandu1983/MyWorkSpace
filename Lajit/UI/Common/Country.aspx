<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Country.aspx.cs" Inherits="LAjitDev.Common.Country" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top" >
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">                                                            
                                                            ...
                                                            <tr id="trTypeOfCountry">  
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblTypeOfCountry" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LAjitDropDownList ID="ddlTypeOfCountry" runat="server" MapXML="TypeOfCountry" Width="206px" ></LCtrl:LAjitDropDownList>
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqTypeOfCountry" runat="server" MapXML="TypeOfCountry" ControlToValidate="ddlTypeOfCountry" ValidationGroup="LAJITEntryForm"
