<%@ Page Language="C#" AutoEventWireup="true" Codebehind="County.aspx.cs" Inherits="LAjitDev.Common.County" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trAbbrev" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label   runat="server" ID="lblAbbrev"  SkinID="Label"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LajitTextBox ID="txtAbbrev" runat="server" MapXML="Abbrev" Width="200px" ></LCtrl:LajitTextBox>                                                                                     
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqAbbrev" MapXML="Abbrev" runat="server" ControlToValidate="txtAbbrev" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr>                                                             
                                                          <tr id="trSelectRegion" >   
                                                                <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblSelectRegion" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlSelectRegion" runat="server" MapXML="SelectRegion" Width="206px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqSelectRegion" runat="server" MapXML="SelectRegion" ControlToValidate="ddlSelectRegion" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr>                                                                                                                                                                                                          
                                                            <tr id="trSelectCountry" >   
                                                                <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label   runat="server" ID="lblSelectCountry" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlSelectCountry" runat="server" MapXML="SelectCountry" Width="206px"></LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqSelectCountry" runat="server" MapXML="SelectCountry" ControlToValidate="ddlSelectCountry" ValidationGroup="LAJITEntryForm"
                                                                        ErrorMessage="Value is required." ToolTip="Value is required." SetFocusOnError="True" Enabled="false"></LCtrl:LAjitRequiredFieldValidator>                                                                   
                                                                </td>
                                                            </tr> 
