<%@ Page Language="C#" AutoEventWireup="true" Codebehind="CurrencyRate.aspx.cs" 
Inherits="LAjitDev.Common.CurrencyRate" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trEffectiveDate" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 196px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblEffectiveDate"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                   <table cellpadding="0" cellspacing="0" border="0">
                                                                     <tr>
                                                                      ...
                                                                      <td>
                                                                       <LCtrl:LAjitRequiredFieldValidator ID="reqEffectiveDate" runat="server" ControlToValidate="txtEffectiveDate"
                                                                        ErrorMessage="Value is required." ValidationGroup="LAJITEntryForm" ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false" MapXML="EffectiveDate">*</LCtrl:LAjitRequiredFieldValidator>
                                                                      </td>   
                                                            ...
                                                            <tr id="trConversionRate" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 196px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblConversionRate"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitTextBox ID="txtConversionRate" runat="server" MapXML="ConversionRate" Width="180px"></LCtrl:LAjitTextBox>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqConversionRate" runat="server" ValidationGroup="LAJITEntryForm"
                                                                        ControlToValidate="txtConversionRate" ErrorMessage="Value is required." ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false"  MapXML="ConversionRate">*</LCtrl:LAjitRequiredFieldValidator>
                                                                    <asp:RegularExpressionValidator ID="regExConversionRate" runat="server" ControlToValidate="txtConversionRate"
                                                                        ValidationExpression="^[+-]?([0-9]*\.?[0-9]+|[0-9]+\.?[0-9]*)([eE][+-]?[0-9]+)?$" ToolTip="Please enter a numeric value." ErrorMessage="Please enter a numeric value."
                                                                        Display="dynamic" ValidationGroup="LAJITEntryForm">*</asp:RegularExpressionValidator>
                                                                </td>
                                                            </tr>
