<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Currency.aspx.cs" Inherits="LAjitDev.Common.Currency" %>
                                                ...
                                                <tr>
                                                    <td align="left" valign="top">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trCurrencyType" align="left" valign="middle" runat="server">
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblCurrencyType"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCurrencyType" runat="server" MapXML="CurrencyType"
                                                                        Width="146px">
                                                                    </LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCurrencyType" runat="server" ControlToValidate="ddlCurrencyType"
                                                                        ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required." ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false" MapXML="CurrencyType">*</LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblIncome"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlIncome" runat="server" MapXML="Income" Width="146px">
                                                                    </LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqIncome" runat="server" ControlToValidate="ddlIncome"
                                                                        ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required." ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false" MapXML="Income">*</LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblCorpJob1"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCorpJob1" runat="server" MapXML="CorpJob1" Width="146px">
                                                                    </LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCorpJob1" runat="server" ControlToValidate="ddlCorpJob1"
                                                                        ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required." ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false" MapXML="CorpJob1">*</LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label  SkinID="Label" runat="server" ID="lblExpense"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlExpense" runat="server" MapXML="Expense" Width="146px">
                                                                    </LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqExpense" runat="server" ControlToValidate="ddlExpense"
                                                                        ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required." ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false" MapXML="Expense">*</LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formtext" style="height: 24px; width: 160px">
                                                                    <asp:Label SkinID="Label" runat="server" ID="lblCorpJob2"></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                    <LCtrl:LAjitDropDownList ID="ddlCorpJob2" runat="server" MapXML="CorpJob2" Width="146px">
                                                                    </LCtrl:LAjitDropDownList>
                                                                    <LCtrl:LAjitRequiredFieldValidator ID="reqCorpJob2" runat="server" ControlToValidate="ddlCorpJob2"
                                                                        ValidationGroup="LAJITEntryForm" ErrorMessage="Value is required." ToolTip="Value is required."
                                                                        SetFocusOnError="True" Enabled="false"  MapXML="CorpJob2">*</LCtrl:LAjitRequiredFieldValidator>
                                                                </td>
                                                            </tr>
