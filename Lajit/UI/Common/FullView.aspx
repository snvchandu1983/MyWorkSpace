<%@ Page Language="C#" AutoEventWireup="true" Codebehind="FullView.aspx.cs" Inherits="LAjitDev.Common.FullView"
                                                 ...
                                                 <tr>
                                                    <td align="left" valign="top" style="height:439px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                                            ...
                                                            <tr id="trHTML" runat="server" valign="middle">                                                                
                                                                <td>
                                                                    <asp:Literal id="litRwTbl" runat="Server"></asp:Literal> 
                                                                </td>
                                                            </tr>
