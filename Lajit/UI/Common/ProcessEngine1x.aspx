<%@ Page Language="C#"  AutoEventWireup="true" Codebehind="ProcessEngine1x.aspx.cs" Inherits="LAjitDev.Common.ProcessEngine1x" 
Title="LAjit :: ProcessEngine1x" Theme="LAjit" %>
...
<asp:content id="Content1" contentplaceholderid="cphPageContents" runat="server">
 <script type="text/javascript">
            ...
            <tr>
                ...
                <td class="tdMainCont">
                    <table class="tblMainCont" cellpadding="0" cellspacing="0" border="0" >
                        ...
                        <tr align="left">
                            <td class="tdEntryFrm">
                                <asp:Panel ID="pnlEntryForm" runat="server" Visible="True" Height="711px">
                                    <!-- entry form start  -->
                                        ...
                                        <tr>
                                            <td align="left" valign="top" style="height: 457px">
                                                <table width="500px" border="0" cellspacing="0" cellpadding="0" align="left">
                                                    ...
                                                    <tr align="left" valign="top" id="trTypeOfJob" runat="server">
                                                        <td class="formtext" style="height: 24px; width: 160px">
                                                            <asp:Label runat="server" ID="lblTypeOfJob" SkinID="Label"></asp:Label>
                                                        </td>
                                                        <td valign="middle">
                                                            <LCtrl:LAjitDropDownList ID="ddlTypeOfJob" runat="server" MapXML="TypeOfJob"
                                                                Width="320px">
                                                            </LCtrl:LAjitDropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr align="left" valign="top" id="trDirectorEmployee" runat="server">
                                                        <td class="formtext" style="height: 24px; width: 160px">
                                                            <asp:Label runat="server" ID="lblDirectorEmployee" SkinID="Label"></asp:Label>
                                                        </td>
                                                        <td valign="middle">
   ...
   <%--<div id="divHvrEmailIDs" style="display:none;">
                       <table border="0" cellpadding="0" cellspacing="0"    >
                            ...
                            <tr>
                        <td colspan="2">
                            <img src="../App_Themes/<%=Session["MyTheme"]%>/Images/spacer.gif" alt="spacer" height="1" />
                        </td> 
                       </tr> 
                            <tr>
                            ...
                            <tr>
                                <td align="center" colspan="2" style="height: 24px; width: 205px" valign="middle">
                                    <LCtrl:LAjitImageButton ID="imgbtnSubmit" runat="server" AlternateText="Submit" CausesValidation="false"
                                        Height="18" OnClientClick="javascript:onSubmitClick()"  ValidationGroup="LAJITEntryForm" />
                                 </td>
                            </tr>
                        </table>
  </div> --%>    
