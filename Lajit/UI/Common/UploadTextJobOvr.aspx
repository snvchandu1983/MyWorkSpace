<%@ Page Language="C#" AutoEventWireup="true" Codebehind="UploadTextJobOvr.aspx.cs"
    Inherits="LAjitDev.Common.UploadTextJobOvr" %>

<asp:content id="Content1" contentplaceholderid="cphPageContents" runat="server">
<script type="text/javascript">
    function JQueryPageEvents() {
         AttachAutoComplete("ctl00_cphPageContents_txtAutoFillJob",'AutoFillJob','<%=this.Page.ToString() %>');
    }
    </script>
    <asp:Panel ID="pnlContent" runat="server">
                                                    ...
                                                    <td align="left" valign="top" style="height:460px;width:925px">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr id="trAutoFillJob" align="left" valign="middle" runat="server">  
                                                                 <td  class="formtext" style="height: 24px; width:160px">
                                                                    <asp:Label  runat="server" ID="lblAutoFillJob" SkinID="Label" ></asp:Label>
                                                                </td>
                                                                <td valign="middle">
                                                                     <LCtrl:LajitTextBox ID="txtAutoFillJob" runat="server" MapXML="AutoFillJob" Width="400px" ></LCtrl:LajitTextBox> 
                                                                     <LCtrl:LAjitRequiredFieldValidator ID="reqAutoFillJob" runat="server" MapXML="AutoFillJob" ControlToValidate="txtAutoFillJob" ValidationGroup="LAJITEntryForm"
       ...
       <input type="hidden" id="hidChecked" name="hidChecked"  runat="server"/> 
        ...
        <asp:HiddenField ID="hdnAutofillJobID" runat="server" />
